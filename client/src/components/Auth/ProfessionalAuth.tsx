        ...
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              {isLogin ? 'Welcome Back' : 'View Demo'}
            </h1>
            <p className="text-gray-600">
              {isLogin
                ? 'Access your personalized government contracting opportunities'
                : 'Try our platform with a demo account or create your own'
              }
            </p>
          </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 flex-1">
                  ...
                  <div className="text-sm text-blue-800 space-y-1">
                    <p className="font-mono bg-white/50 px-2 py-1 rounded inline-block">
                      Email: demo@demo.com
                    </p>
                    <br />
                    <p className="font-mono bg-white/50 px-2 py-1 rounded inline-block mt-1">
                      Password: demo123
                    </p>
                  </div>
                </div>
